...
function App() {
  ...
  return (
    ...
    <div className="flex w-full">
      <div className={showSidebar ? '2xl:w-1/5 xl:w-1/4 md:w-1/3 smd:w-2/5  esm:w-[80%] w-full smd:rounded-tr-2xl border-t smd:border-l-0 border-l esm:rounded-tl-2xl smd:rounded-tl-none smd:border-r smd:relative fixed top-0 right-0 z-10' : '2xl:w-1/5 xl:w-1/4 md:w-1/3 smd:w-2/5  esm:w-[80%] smd:rounded-tr-2xl border-t smd:border-l-0 border-l esm:rounded-tl-2xl smd:rounded-tl-none smd:border-r smd:relative fixed top-0 right-[-1000%] smd:right-0 z-10'}>
